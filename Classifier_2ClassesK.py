...
for w in words_list_input:
        prob_w_motor = prob_w_motor + math.log10((word_count1[w] + k) / (words_number1+(k * vocab_size)))
        prob_w_base = prob_w_base + math.log10((word_count2[w] + k) / (words_number2+(k * vocab_size)))
